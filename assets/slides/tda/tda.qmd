...
- To learn more about TDA for Machine Learning, see Bastian Rieck's
 [Topological Data Analysis for Machine Learning](https://bastian.rieck.me/talks/ecml_pkdd_2020/) workshop (around 4 hours total)

- For a course in TDA, see Raphael Tinarrage's [Topological Data Analysis with Persistent Homology](https://raphaeltinarrage.github.io/EMAp.html) summer course
